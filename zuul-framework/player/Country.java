...
public enum Country {
    VAKANNDA(53,50, 1.00, 61,34,5, 6, new HashMap<>() {{
        ...
        put("infant mortality", "\"You died within the first months of your life. " +
    ...
    DANHEIM(5,500,1.35, 20,70,10, 2, new HashMap<>() {{
        ...
        put("depression and you want to commit suicide", "Suicide constitutes 1.1% of yearly deaths or approximately" +
                " two suicides pr day");
        put("infant mortality"," You have died within the first months of your life. Even with access to healthcare, and " +
